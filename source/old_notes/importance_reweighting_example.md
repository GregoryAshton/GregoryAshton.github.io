...
![corner](/old_notes/importance_reweighting/full_corner.png)

Second, the posterior when fixing `c=0`

![corner](/old_notes/importance_reweighting/partial_corner.png)

Finally, the rewighted posterior from fixed case

![posterior](/old_notes/importance_reweighting/posterior.png)
